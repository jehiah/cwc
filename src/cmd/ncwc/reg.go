...
var allReg []Reg = []Reg{
	...
	{Code: "54-13(a)(3)(xi)", Description: "improper passing (taxi)", Type: "-"},
	{Code: "54-13(a)(3)(vi)", Description: "failing to yield right of way (taxi)", Type: "-"},
	{Code: "54-13(a)(3)(vii)", Description: "traffic signal violation (taxi)", Type: "-"},
	{Code: "54-13(a)(3)(ix)", Description: "yield sign violation (taxi)", Type: "-"},
	{Code: "55-13(a)(3)(xi)", Description: "improper passing (fhv)", Type: "-"},
	{Code: "55-13(a)(3)(vi)", Description: "failing to yield right of way (fhv)", Type: "-"},
	{Code: "55-13(a)(3)(vii)", Description: "traffic signal violation (fhv)", Type: "-"},
	{Code: "55-13(a)(3)(ix)", Description: "yield sign violation (fhv)", Type: "-"},
